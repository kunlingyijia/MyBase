...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    if (self) {
        ...
        _redView.frame =CGRectMake(0, IMenuWidth*0.12-2, IMenuWidth/5.3, 2);
...
- (IBAction)IMenuTabOneCellBtnAction:(UIButton *)sender {
    ...
    self.IMenuTabOneCellBlock(sender.tag-100,self.IsOpen,self.IsUp);
